  ...
  head: () => ({
    meta: [
      { title: "Background Verification Services USA — XSpark Careers" },
      {
        name: "description",
        content:
          "Protect your business with thorough employee background checks, employment verification, education screening, and criminal background check services. Trusted by companies across the USA.",
      },
      { property: "og:title", content: "Background Verification Services USA — XSpark Careers" },
      {
        property: "og:description",
        content: "Comprehensive employee background checks with 24–48 hour turnaround.",
      },
    ],
  }),
...
const services = [
  {
    ...
    desc: "Comprehensive employment history verification including job titles, dates of employment, and salary confirmation.",
  },
  {
    icon: GraduationCap,
    title: "Education Verification",
    desc: "Verify academic credentials including degrees, diplomas, certifications, and attendance.",
  },
  {
    icon: Shield,
    title: "Criminal Background Check",
    desc: "Thorough criminal background screening including federal, state, and county records.",
  },
  {
    icon: UserCheck,
    title: "Reference Verification",
    desc: "Validate candidate credibility through direct feedback from previous employers.",
  },
];
...
const quickChecks = [
  {
    ...
    desc: "Comprehensive criminal background check service USA with nationwide coverage.",
  },
  {
    icon: Briefcase,
    title: "Employment Verification",
    desc: "Complete employment verification services USA for all previous employers.",
  },
  {
    icon: GraduationCap,
    title: "Education Verification",
    desc: "Education & employment verification directly with institutions.",
  },
];
...
const faqs = [
  {
    q: "What is included in a pre-employment background check?",
    a: "Our standard pre-employment background check covers criminal history (federal, state, county), employment verification, education verification, and reference checks. Optional add-ons include credit, drug, motor vehicle, and global searches.",
  },
  {
    q: "How long does a background check take?",
    a: "Most background checks are completed within 24–48 hours. Complex cases involving international records or court delays may take 3–5 business days.",
  },
  {
    q: "Are your background checks FCRA compliant?",
    a: "Yes. All our screening processes are fully compliant with the Fair Credit Reporting Act (FCRA), state-specific regulations, and EEOC guidelines.",
  },
  {
    q: "Do you offer global background checks?",
    a: "Yes — we have unmatched global reach with verification capabilities across 200+ countries, including international criminal, education, and employment checks.",
  },
  {
    q: "Can you verify professional licenses and credentials?",
    a: "Absolutely. We contact the associated state government, granting source, or issuing agency directly to verify status, sanctions, restrictions, and expiration dates.",
  },
  {
    q: "Why is pre-employment background screening important?",
    a: "It helps you make smart, well-informed hiring decisions, reduces turnover, protects your workplace, and ensures the individuals you hire fit well within your culture.",
  },
];
  ...
  return (
    <main className="pt-28 pb-20">
      ...
      <section className="container-x grid gap-10 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <p className="mt-5 text-lg text-navy/70">
            XSpark helps businesses make informed hiring decisions through comprehensive employee
            screening services, ensuring accuracy, compliance, and peace of mind throughout the
            recruitment process.
          </p>
      ...
      <section className="container-x mt-24">
        <div className="max-w-3xl">
          <h2 className="font-display text-3xl font-bold text-navy sm:text-4xl">
            Complete Candidate Verification Services
          </h2>
          <p className="mt-4 text-navy/70">
            Verify credentials, employment history, education, and background information through
            reliable screening solutions designed to support secure and compliant hiring.
          </p>
          <Link
            to="/contact"
      ...
      <section className="container-x mt-24 space-y-12">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-navy/70">
              Make informed hiring decisions with comprehensive pre-employment screening services
              designed to verify candidate information, identify potential risks, and support
              compliance requirements.
            </p>
            <ul className="mt-5 space-y-3 text-sm text-navy/80">
              <li className="flex gap-3">
                <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary" />
                Our background screening solutions include criminal record searches, identity
                verification, employment and education checks, sanctions screening, and other
                essential assessments to help organizations hire with confidence.
              </li>
              <li className="flex gap-3">
                <CheckCircle2 className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary" />
                With access to extensive domestic and international screening resources, XSpark
                supports businesses in conducting reliable background checks across multiple
                regions, helping ensure a secure and trustworthy workforce.
              </li>
            </ul>
          </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-navy/70">
              Pre-employment background checks help organizations make informed hiring decisions by
              verifying candidate information, reducing hiring risks, and supporting workplace
              safety and compliance.
            </p>
            <p className="mt-3 text-navy/70">
              By validating employment history, education credentials, professional qualifications,
              and other critical information, employers can confidently identify candidates who
              align with both the role requirements and company culture. A thorough background
              screening process not only protects your organization but also contributes to stronger
              hiring outcomes, improved employee retention, and a more secure workplace.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-navy/70">
              Ensure candidates possess the qualifications required for the role through
              comprehensive license and credential verification services. We validate professional
              certifications, licenses, and accreditations directly with the appropriate issuing
              authorities to confirm their authenticity and current standing.
            </p>
            <p className="mt-3 text-navy/70">
              Our verification process helps identify active status, expiration dates, restrictions,
              disciplinary actions, and other relevant details, enabling organizations to make
              informed and compliant hiring decisions.
            </p>
          </div>
          <div className="order-1 rounded-3xl bg-gradient-to-br from-primary/10 to-primary/0 p-8 lg:order-2">
            <img
      ...
      <section className="container-x mt-24">
        <div className="max-w-3xl">
          <h2 className="font-display text-3xl font-bold text-navy sm:text-4xl">
            Fast, Reliable Background Screening
          </h2>
          <p className="mt-4 text-navy/70">
            Accelerate your hiring process with comprehensive screening services that verify
            candidate credentials, employment history, education, and background information. Our
            efficient verification process helps organizations reduce risk and hire with confidence.
          </p>
        </div>
      ...
      <section className="container-x mt-24">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-navy/70">
            Everything you need to know about our background verification services. If you're
