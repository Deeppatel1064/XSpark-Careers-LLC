  ...
  head: () => ({
    meta: [
      { title: "Job Placement Services — XSpark Careers" },
      {
        name: "description",
        content:
          "End-to-end job placement services: resume writing, interview coaching, job applications, and direct placement with 230+ partner companies.",
      },
      { property: "og:title", content: "Job Placement Services — XSpark Careers" },
      {
        property: "og:description",
        content:
          "1750+ successful placements. 98% resume success rate. Get hired in 45 days on average.",
      },
    ],
  }),
...
const services = [
  {
    ...
    desc: "Direct placement into full-time roles with our 230+ partner companies across the US.",
  },
  {
    title: "Resume Writing",
    desc: "ATS-friendly resumes crafted by experts — 98% of clients land interviews.",
  },
  {
    title: "Interview Coaching",
    desc: "Mock interviews, technical prep, and behavioral coaching from senior engineers.",
  },
  {
    title: "Job Applications",
    desc: "We apply to relevant roles on your behalf — saving you 20+ hours a week.",
  },
];
...
const steps = [
  {
    ...
    desc: "Understand your background, goals, and visa status.",
  },
  {
    n: "02",
    title: "Profile Enhancement",
    desc: "Rewrite your resume, LinkedIn, and portfolio for impact.",
  },
  {
    n: "03",
    title: "Interview Process",
    desc: "Mock interviews and tailored prep for each target role.",
  },
  {
    n: "04",
    title: "Job Matching",
    desc: "We submit you to roles aligned with your skills and salary band.",
  },
  {
    n: "05",
    title: "Successful Placement",
    desc: "Offer negotiation and onboarding support — all the way in.",
  },
];
...
const faqs = [
  {
    q: "Who is eligible for the job placement program?",
    a: "Recent graduates, working professionals, and candidates on F1/OPT/CPT/H1B/GC/USC are all welcome.",
  },
  {
    q: "How long does it take to get placed?",
    a: "On average our candidates are placed within 45 days of joining the program.",
  },
  {
    q: "Do you guarantee a job?",
    a: "We don't guarantee a job, but our 98% interview success rate speaks for itself.",
  },
  {
    q: "What salary range can I expect?",
    a: "Our placed candidates typically earn between $85K and $170K depending on experience and stack.",
  },
  {
    q: "Is the program online or in-person?",
    a: "Fully online — coaching, mock interviews, and submissions are all remote-friendly.",
  },
];
    ...
    <main className="pt-28 pb-20">
      <section className="container-x">
        <div className="mt-4 max-w-3xl">
          ...
          <p className="mt-3 text-lg font-semibold text-primary">
            Accelerate your career with expert job-search support and access to top opportunities.
          </p>
          <p className="mt-4 text-navy/70">
            From professional resume development and interview preparation to direct placement
            through our network of 230+ hiring partners, we manage every stage of your job
            search—helping you secure the right role faster and maximize your earning potential.
          </p>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-border bg-white p-6 hover-lift hover:border-primary/40">
            <h3 className="font-display text-lg font-semibold text-navy">
              Conventional Job Search Approach
            </h3>
          ...
          <div className="rounded-2xl bg-gradient-to-br from-primary to-primary/70 p-6 text-primary-foreground shadow-glow">
            <h3 className="font-display text-lg font-semibold">
              The XSpark Career Acceleration Program
            </h3>
      ...
      <section className="container-x mt-20">
        ...
        <p className="mt-2 text-navy/70">
          F1 / OPT / CPT / H1B / GC / USC across IT, data, cloud, QA, and product roles.
        </p>
        <div className="mt-6 flex flex-wrap gap-2">
          {[
            ...
            <span
              key={t}
              className="rounded-full bg-secondary px-4 py-1.5 text-sm font-medium text-navy"
            >
              {t}
            </span>
          ))}
      ...
      <section className="container-x mt-20">
        <div className="rounded-3xl bg-gradient-to-br from-primary to-primary/70 p-10 text-center text-primary-foreground shadow-glow">
          ...
          <p className="mt-2 opacity-90">
            Book a free consultation and let's build your placement plan.
          </p>
          <Link
            to="/book-consultation"
            className="hover-lift-sm mt-6 inline-flex rounded-full bg-white px-6 py-3 text-sm font-semibold text-primary"
          >
            Get Started
          </Link>
        </div>
