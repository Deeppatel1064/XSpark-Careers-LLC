...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with XSpark Careers. Email, phone, address and office hours." },
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <Reveal className="lg:col-span-2">
            <div className="h-full rounded-3xl gradient-primary p-8 text-primary-foreground shadow-elegant">
              ...
              <p className="mt-2 text-sm text-white/80">A senior consultant will get back to you within 24 hours.</p>

              <ul className="mt-8 space-y-5">
                <Info icon={Mail} label="Email" value="info@xsparkcareersllc.com" />
                <Info icon={Phone} label="Phone" value="+1 442 393 2403" />
                <Info icon={MapPin} label="Headquarters" value="8 The Green STE A, Dover, Delaware, United States, 19901" />
                <Info icon={Clock} label="Working hours" value="Mon – Fri · 9:00 AM – 7:00 PM (ET)" />
              </ul>
